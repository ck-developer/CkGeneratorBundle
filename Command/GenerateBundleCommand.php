...
use Ck\Bundle\GeneratorBundle\Generator\BundleGenerator;
    ...
    protected function configure()
    {
        $this
            ->setDefinition(array(
                ...
                new InputOption('web', '', InputOption::VALUE_NONE, 'Whether to generate the whole directory structure'),
            ))
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $generator->generate($namespace, $bundle, $dir, $format, $structure, $web);
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (null === $format) {
            ...
            $question->setValidator(
                array('Ck\Bundle\GeneratorBundle\Command\Validators', 'validateFormat')
            );
        ...
        $web = $input->getOption('web');
        $question = new ConfirmationQuestion($questionHelper->getQuestion('Do you want to generate the web structure', 'no', '?'), false);
        if (!$web && $questionHelper->ask($input, $output, $question)) {
            $web = true;
        }
        $input->setOption('web', $web);
